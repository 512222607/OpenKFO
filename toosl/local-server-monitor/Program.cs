    ...
    string Hex, string Content, string Raw)
{
    ...
    {
        [4110]="玩家结算报告",[20407]="PVE结束标记",[20571]="波次结束上报",[20572]="闯关波次控制",
        ...
        [4030]="玩家准备",[4050]="准备状态通知",[4060]="取消准备",[4070]="取消准备通知",[4080]="加载战斗",[4081]="开战失败",[4120]="房间 / 战斗实体数据",[4124]="完成新手引导",[4125]="称号与奖励候选",[4126]="选择奖励武器",[4140]="玩家返回网络检测",[4150]="服务器发起网络检测",[4160]="资源加载完成",[4170]="玩家资源就绪",[4180]="全员资源就绪",[6000]="查询任务及待领取奖励",
