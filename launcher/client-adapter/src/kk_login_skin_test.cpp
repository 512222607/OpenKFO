...
int wmain(int count, wchar_t** args) {
    ...
    WNDCLASSW type = {}; type.hInstance = instance; type.lpfnWndProc = windowProcedure; type.lpszClassName = L"LoginSkinTest";
    RegisterClassW(&type);
    ...
    if (!install || !install(dialog) || !install(dialog)) return 2;
